...
-- Move o único usuário (João) para a org principal e arquiva a org antiga
-- preservando o audit trail. Migration NÃO é aplicada automaticamente —
-- aplicação manual via Lovable depois (Orion confirma).
...
-- 3. Renomear org antiga para sinalizar arquivamento. NÃO deletamos:
--    queremos preservar referências históricas (FKs com ON DELETE SET NULL).
